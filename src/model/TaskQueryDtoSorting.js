...
class TaskQueryDtoSorting {
    /**
     * @member {TaskQueryDtoSorting.SortByEnum} sortBy
     * @type {TaskQueryDtoSorting.SortByEnum}
     */
    sortBy;
    /**
     * @member {TaskQueryDtoSorting.SortOrderEnum} sortOrder
     * @type {TaskQueryDtoSorting.SortOrderEnum}
     */
    sortOrder;
    /**
     * @member {SortTaskQueryParametersDto} parameters
