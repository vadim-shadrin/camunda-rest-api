...
* @version 7.14.0
*/
export default class TaskLocalVariableApi extends ApiClient {
    ...
    */
     ...
     * @return {Promise}
     */
    async deleteTaskLocalVariable(id, varName) {
      let postBody = null;
     ...
     */
    async getTaskLocalVariable(id, varName, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     * @return {Promise<File>}
     */
    async getTaskLocalVariableBinary(id, varName) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     */
    async getTaskLocalVariables(id, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     * @return {Promise}
     */
    async modifyTaskLocalVariables(id, opts) {
      opts = opts || {};
     ...
     * @return {Promise}
     */
    async putTaskLocalVariable(id, varName, opts) {
      opts = opts || {};
     ...
     * @return {Promise}
     */
    async setBinaryTaskLocalVariable(id, varName, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
