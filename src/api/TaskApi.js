...
* @version 7.14.0
*/
export default class TaskApi extends ApiClient {
    ...
    */
     ...
     * @param {UserIdDto} opts.userIdDto Provide the id of the user that claims the task.
     * @return {Promise}
     */
    async claim(id, opts) {
      opts = opts || {};
     ...
     * @param {Object} opts Optional parameters
     * @param {CompleteTaskDto} opts.completeTaskDto 
     ...
     * @param {Object} opts Optional parameters
     * @param {UserIdDto} opts.userIdDto Provide the id of the user that the task should be delegated to.
     * @return {Promise}
     */
    async delegateTask(id, opts) {
      opts = opts || {};
      let postBody = opts['userIdDto'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     * @return {Promise<Object.<String, {String: VariableValueDto}>>}
     */
    async getFormVariables(id, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     * @param {String} opts.delegationState Restrict to tasks that are in the given delegation state. Valid values are `PENDING` and `RESOLVED`.
     ...
     * @param {Object} opts Optional parameters
     * @param {TaskBpmnErrorDto} opts.taskBpmnErrorDto 
     * @return {Promise}
     */
    async handleBpmnError(id, opts) {
      opts = opts || {};
     ...
     * @param {Object} opts Optional parameters
     * @param {TaskEscalationDto} opts.taskEscalationDto 
     * @return {Promise}
     */
    async handleEscalation(id, opts) {
      opts = opts || {};
     ...
     * @param {Number} opts.firstResult Pagination of results. Specifies the index of the first result to return.
     * @param {Number} opts.maxResults Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left.
     * @param {TaskQueryDto} opts.taskQueryDto 
     * @return {Promise<Array.<TaskDto>>}
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {UserIdDto} opts.userIdDto Provide the id of the user that will be the assignee of the task.
     * @return {Promise}
     */
    async setAssignee(id, opts) {
      opts = opts || {};
      let postBody = opts['userIdDto'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
