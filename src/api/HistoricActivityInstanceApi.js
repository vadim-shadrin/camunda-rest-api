...
* @version 7.14.0
*/
export default class HistoricActivityInstanceApi extends ApiClient {
    ...
    */
     ...
     * @return {Promise<HistoricActivityInstanceDto>}
     */
    async getHistoricActivityInstance(id) {
      let postBody = null;
     ...
     * @return {Promise<Array.<HistoricActivityInstanceDto>>}
     */
    async getHistoricActivityInstances(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    async getHistoricActivityInstancesCount(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @param {Number} opts.firstResult Pagination of results. Specifies the index of the first result to return.
     * @param {Number} opts.maxResults Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left.
     * @param {HistoricActivityInstanceQueryDto} opts.historicActivityInstanceQueryDto 
     * @return {Promise<Array.<HistoricActivityInstanceDto>>}
     */
    async queryHistoricActivityInstances(opts) {
      opts = opts || {};
     ...
     * @return {Promise<CountResultDto>}
     */
    async queryHistoricActivityInstancesCount(opts) {
      opts = opts || {};
      let postBody = opts['historicActivityInstanceQueryDto'];
