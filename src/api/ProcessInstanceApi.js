...
* @version 7.14.0
*/
export default class ProcessInstanceApi extends ApiClient {
    ...
    */
     ...
     * @param {DeleteProcessInstancesDto} opts.deleteProcessInstancesDto **Unallowed property**: `processInstanceQuery`
     * @return {Promise<BatchDto>}
     */
    async deleteAsyncHistoricQueryBased(opts) {
      opts = opts || {};
     ...
     * @return {Promise}
     */
    async deleteProcessInstance(id, opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @return {Promise}
     */
    async deleteProcessInstanceVariable(id, varName) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     * @param {Object} opts Optional parameters
     * @param {DeleteProcessInstancesDto} opts.deleteProcessInstancesDto **Unallowed property**: `historicProcessInstanceQuery`
     * @return {Promise<BatchDto>}
     */
    async deleteProcessInstancesAsyncOperation(opts) {
      opts = opts || {};
      let postBody = opts['deleteProcessInstancesDto'];
     ...
     * @return {Promise<ActivityInstanceDto>}
     */
    async getActivityInstanceTree(id) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     */
    async getProcessInstanceVariable(id, varName, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     * @return {Promise<File>}
     */
    async getProcessInstanceVariableBinary(id, varName) {
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     */
    async getProcessInstanceVariables(id, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     */
    async getProcessInstances(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     */
    async getProcessInstancesCount(opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @param {Object} opts Optional parameters
     * @param {ProcessInstanceModificationDto} opts.processInstanceModificationDto 
     * @return {Promise}
     */
    async modifyProcessInstance(id, opts) {
      opts = opts || {};
     ...
     * @return {Promise<BatchDto>}
     */
    async modifyProcessInstanceAsyncOperation(id, opts) {
      opts = opts || {};
      let postBody = opts['processInstanceModificationDto'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     * @return {Promise}
     */
    async modifyProcessInstanceVariables(id, opts) {
      opts = opts || {};
     ...
     * @param {Number} opts.firstResult Pagination of results. Specifies the index of the first result to return.
     * @param {Number} opts.maxResults Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left.
     * @param {ProcessInstanceQueryDto} opts.processInstanceQueryDto 
     * @return {Promise<Array.<ProcessInstanceDto>>}
     */
    async queryProcessInstances(opts) {
      opts = opts || {};
     ...
     * @return {Promise<CountResultDto>}
     */
    async queryProcessInstancesCount(opts) {
      opts = opts || {};
      let postBody = opts['processInstanceQueryDto'];
     ...
     * @return {Promise}
     */
    async setProcessInstanceVariable(id, varName, opts) {
      opts = opts || {};
     ...
     * @return {Promise}
     */
    async setProcessInstanceVariableBinary(id, varName, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
     ...
     * @param {Object} opts Optional parameters
     * @param {SetJobRetriesByProcessDto} opts.setJobRetriesByProcessDto Please note that if both processInstances and processInstanceQuery are provided, then the resulting execution will be performed on the union of these sets. **Unallowed property**: `historicProcessInstanceQuery`
     * @return {Promise<BatchDto>}
     */
    async setRetriesByProcess(opts) {
      opts = opts || {};
     ...
     * @param {Object} opts Optional parameters
     * @param {SetJobRetriesByProcessDto} opts.setJobRetriesByProcessDto Please note that if both processInstances and historicProcessInstanceQuery are provided, then the resulting execution will be performed on the union of these sets. **Unallowed property**: `processInstanceQuery`
     * @return {Promise<BatchDto>}
     */
    async setRetriesByProcessHistoricQueryBased(opts) {
      opts = opts || {};
      let postBody = opts['setJobRetriesByProcessDto'];
     ...
     * @param {Object} opts Optional parameters
     * @param {SetVariablesAsyncDto} opts.setVariablesAsyncDto 
     * @return {Promise<BatchDto>}
     */
    async setVariablesAsyncOperation(opts) {
      opts = opts || {};
     ...
     * @param {Object} opts Optional parameters
     * @param {ProcessInstanceSuspensionStateDto} opts.processInstanceSuspensionStateDto 
     * @return {Promise}
     */
    async updateSuspensionState(opts) {
      opts = opts || {};
     ...
     * @param {Object} opts Optional parameters
     * @param {ProcessInstanceSuspensionStateAsyncDto} opts.processInstanceSuspensionStateAsyncDto 
     * @return {Promise<BatchDto>}
     */
    async updateSuspensionStateAsyncOperation(opts) {
      opts = opts || {};
     ...
     * @param {Object} opts Optional parameters
     * @param {SuspensionStateDto} opts.suspensionStateDto 
     * @return {Promise}
     */
    async updateSuspensionStateById(id, opts) {
      opts = opts || {};
