...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CamundaBpmRestApi.ProcessInstanceSuspensionStateAsyncDto();
  });
  ...
  describe('ProcessInstanceSuspensionStateAsyncDto', function() {
    it('should create an instance of ProcessInstanceSuspensionStateAsyncDto', function() {
      // uncomment below and update the code to test ProcessInstanceSuspensionStateAsyncDto
      //var instance = new CamundaBpmRestApi.ProcessInstanceSuspensionStateAsyncDto();
      //expect(instance).to.be.a(CamundaBpmRestApi.ProcessInstanceSuspensionStateAsyncDto);
    });
    ...
    it('should have the property suspended (base name: "suspended")', function() {
      ...
      //var instane = new CamundaBpmRestApi.ProcessInstanceSuspensionStateAsyncDto();
