...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CamundaBpmRestApi.ProcessInstanceDtoAllOf();
  });
  ...
  describe('ProcessInstanceDtoAllOf', function() {
    it('should create an instance of ProcessInstanceDtoAllOf', function() {
      // uncomment below and update the code to test ProcessInstanceDtoAllOf
      //var instance = new CamundaBpmRestApi.ProcessInstanceDtoAllOf();
      //expect(instance).to.be.a(CamundaBpmRestApi.ProcessInstanceDtoAllOf);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instane = new CamundaBpmRestApi.ProcessInstanceDtoAllOf();
