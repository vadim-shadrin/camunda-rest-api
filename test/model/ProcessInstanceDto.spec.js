...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CamundaBpmRestApi.ProcessInstanceDto();
  });
  ...
  describe('ProcessInstanceDto', function() {
    it('should create an instance of ProcessInstanceDto', function() {
      // uncomment below and update the code to test ProcessInstanceDto
      //var instance = new CamundaBpmRestApi.ProcessInstanceDto();
      //expect(instance).to.be.a(CamundaBpmRestApi.ProcessInstanceDto);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instane = new CamundaBpmRestApi.ProcessInstanceDto();
