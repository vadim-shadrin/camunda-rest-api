...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CamundaBpmRestApi.SetVariablesAsyncDto();
  });
  ...
  describe('SetVariablesAsyncDto', function() {
    it('should create an instance of SetVariablesAsyncDto', function() {
      // uncomment below and update the code to test SetVariablesAsyncDto
      //var instance = new CamundaBpmRestApi.SetVariablesAsyncDto();
      //expect(instance).to.be.a(CamundaBpmRestApi.SetVariablesAsyncDto);
    });
    ...
    it('should have the property processInstanceIds (base name: "processInstanceIds")', function() {
      ...
      //var instane = new CamundaBpmRestApi.SetVariablesAsyncDto();
