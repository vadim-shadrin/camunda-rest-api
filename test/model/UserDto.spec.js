...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CamundaBpmRestApi.UserDto();
  });
  ...
  describe('UserDto', function() {
    it('should create an instance of UserDto', function() {
      ...
      //var instance = new CamundaBpmRestApi.UserDto();
      //expect(instance).to.be.a(CamundaBpmRestApi.UserDto);
    });
    ...
    it('should have the property profile (base name: "profile")', function() {
      ...
      //var instane = new CamundaBpmRestApi.UserDto();
