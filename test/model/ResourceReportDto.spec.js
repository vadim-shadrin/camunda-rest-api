...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CamundaBpmRestApi.ResourceReportDto();
  });
  ...
  describe('ResourceReportDto', function() {
    it('should create an instance of ResourceReportDto', function() {
      // uncomment below and update the code to test ResourceReportDto
      //var instance = new CamundaBpmRestApi.ResourceReportDto();
      //expect(instance).to.be.a(CamundaBpmRestApi.ResourceReportDto);
    });

    it('should have the property errors (base name: "errors")', function() {
      // uncomment below and update the code to test the property errors
      //var instane = new CamundaBpmRestApi.ResourceReportDto();
