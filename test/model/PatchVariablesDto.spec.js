...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CamundaBpmRestApi.PatchVariablesDto();
  });
  ...
  describe('PatchVariablesDto', function() {
    it('should create an instance of PatchVariablesDto', function() {
      // uncomment below and update the code to test PatchVariablesDto
      //var instance = new CamundaBpmRestApi.PatchVariablesDto();
      //expect(instance).to.be.a(CamundaBpmRestApi.PatchVariablesDto);
    });
    ...
    it('should have the property modifications (base name: "modifications")', function() {
      ...
      //var instane = new CamundaBpmRestApi.PatchVariablesDto();
