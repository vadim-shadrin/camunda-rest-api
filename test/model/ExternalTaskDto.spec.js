...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CamundaBpmRestApi.ExternalTaskDto();
  });
  ...
  describe('ExternalTaskDto', function() {
    it('should create an instance of ExternalTaskDto', function() {
      // uncomment below and update the code to test ExternalTaskDto
      //var instance = new CamundaBpmRestApi.ExternalTaskDto();
      //expect(instance).to.be.a(CamundaBpmRestApi.ExternalTaskDto);
    });
    ...
    it('should have the property activityId (base name: "activityId")', function() {
      ...
      //var instane = new CamundaBpmRestApi.ExternalTaskDto();
