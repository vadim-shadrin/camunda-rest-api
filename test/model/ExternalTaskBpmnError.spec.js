...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CamundaBpmRestApi.ExternalTaskBpmnError();
  });
  ...
  describe('ExternalTaskBpmnError', function() {
    it('should create an instance of ExternalTaskBpmnError', function() {
      // uncomment below and update the code to test ExternalTaskBpmnError
      //var instance = new CamundaBpmRestApi.ExternalTaskBpmnError();
      //expect(instance).to.be.a(CamundaBpmRestApi.ExternalTaskBpmnError);
    });
    ...
    it('should have the property workerId (base name: "workerId")', function() {
      ...
      //var instane = new CamundaBpmRestApi.ExternalTaskBpmnError();
