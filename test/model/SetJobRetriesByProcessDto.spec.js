...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CamundaBpmRestApi.SetJobRetriesByProcessDto();
  });
  ...
  describe('SetJobRetriesByProcessDto', function() {
    it('should create an instance of SetJobRetriesByProcessDto', function() {
      // uncomment below and update the code to test SetJobRetriesByProcessDto
      //var instance = new CamundaBpmRestApi.SetJobRetriesByProcessDto();
      //expect(instance).to.be.a(CamundaBpmRestApi.SetJobRetriesByProcessDto);
    });
    ...
    it('should have the property processInstances (base name: "processInstances")', function() {
      ...
      //var instane = new CamundaBpmRestApi.SetJobRetriesByProcessDto();
