...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CamundaBpmRestApi.SignalDto();
  });
  ...
  describe('SignalDto', function() {
    it('should create an instance of SignalDto', function() {
      // uncomment below and update the code to test SignalDto
      //var instance = new CamundaBpmRestApi.SignalDto();
      //expect(instance).to.be.a(CamundaBpmRestApi.SignalDto);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instane = new CamundaBpmRestApi.SignalDto();
