...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CamundaBpmRestApi.AttachmentDtoAllOf();
  });
  ...
  describe('AttachmentDtoAllOf', function() {
    it('should create an instance of AttachmentDtoAllOf', function() {
      // uncomment below and update the code to test AttachmentDtoAllOf
      //var instance = new CamundaBpmRestApi.AttachmentDtoAllOf();
      //expect(instance).to.be.a(CamundaBpmRestApi.AttachmentDtoAllOf);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instane = new CamundaBpmRestApi.AttachmentDtoAllOf();
